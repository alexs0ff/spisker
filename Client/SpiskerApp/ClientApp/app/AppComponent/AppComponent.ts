...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(private authService: AuthentificateService, private router: Router, private socialService: SocialService, @Inject(PLATFORM_ID) private platformId: Object, private oauthService:OAuth2Service) {
