...
@NgModule({
    imports: [BrowserModule, HttpClientModule, AppRoutingModule, HomeModule, AuthModule, ErrorFlowModule, UtilsModule, RegisterModule, AccountModule, MainMenuModule, SettingsModule],
    declarations: [AppComponent],
    bootstrap: [AppComponent],
    providers: [AuthentificateService, Sender, OAuth2Service, FeedListService, ErrorFlowService, ListItemDragAndDropService, SocialService, AccountService, AuthGuard, ListViewDialogService, ClipboardService]
})
